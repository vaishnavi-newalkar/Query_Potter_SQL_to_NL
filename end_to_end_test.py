    ...
    tests = [
        {
            ...
            "question": "Who spent the most overall?"

        },
        {
            "name": "TEST 2: AGGREGATION Query (revenue by customer)",
            "question": "Show everything that is no longer available for purchase"
        },
        {
            "name": "TEST 3: BASIC Query (all products)",
            "question": "Which things bring in the highest income?"
        },
        {
            "name": "TEST 4: EXISTENTIAL Query (customers with orders)",
            "question": "Who has made the greatest number of purchases?"
        },
        {
            "name": "TEST 5: ABSENCE Query (products never ordered)",
            "question": "Rank buyers by how much they have paid in total."
        },
    ]
